<div style="display: flex; align-items: center;">
    <h1 style="color: #222 ; margin-right: 10px;">DATA SCIENCE PROJECTS</h1>
</div>
...
a Path to Resilience
  ...
  <div style="padding: 20px; color: #222; text-align: justify;">
    ...
    <br><br>
    <a href="https://github.com/Github4Aakanksha/Research-Papers/blob/main/Research Paper on Turkey's Economic Crisis.pdf"
       style="
       display: inline-block;
       padding: 10px 20px;
       background-color:#003B5C;
...
">
  ...
  <div style="padding: 20px; color: #222; text-align: justify;">
    ...
    <a href="https://github.com/Github4Aakanksha/Research-Papers/blob/main/Review Paper on Wassily Leontief's Paradox.pdf"
       style="
       display: inline-block;
       padding: 10px 20px;
       background-color:#003B5C;
...
">
  ...
  <div style="padding: 20px; color: #222; text-align: justify;">
    ...
    <a href="https://github.com/Github4Aakanksha/Research-Papers/blob/main/Research.pdf"
       style="
       display: inline-block;
       padding: 10px 20px;
       background-color:#003B5C;
...
Subbarao"
  ...
  <div style="padding: 20px; color: #222; text-align: justify;">
    ...
    <a href="https://github.com/Github4Aakanksha/Research-Papers/blob/main/review paper.pdf"
       style="
       display: inline-block;
       padding: 10px 20px;
       background-color:#003B5C;
